...
> Strategic service-composition roadmap: active PMS/Feishu path is `adapter-feishu -> pms-agent-v2 -> pms-platform`; archived pre-cutover roadmaps are not active implementation truth.
>
