...
> Strategic service-composition roadmap: active PMS/Feishu path is `adapter-feishu -> ai-conversation -> pms-platform`; archived pre-cutover roadmaps are not active implementation truth.
>
